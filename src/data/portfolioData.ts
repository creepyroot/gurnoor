...
export const portfolioData = {
      ...
      vulnerabilities: [
        {
          target: "Google",
          description:
            "Responsible disclosure of Server-Side Request Forgery (SSRF) bypass in testing workspace endpoints.",
          severity: "Critical",
        ...
        },
        {
          target: "Tesla",
          description:
            "Identification of authentication flow bypass in remote telemetry system dashboard leading to info disclosure.",
          severity: "Critical",
        ...
        },
        {
          target: "Microsoft",
          description:
            "Subdomain takeover possibility and leaked third-party OAuth app identifiers in cloud resource setup.",
          severity: "High",
        ...
        },
        {
          target: "Tinder",
          description:
            "IDOR (Insecure Direct Object Reference) yielding leak of sensitive API telemetry parameters.",
          severity: "High",
        ...
        },
        {
          target: "Apple",
          description:
            "Race condition in validation handler for custom developers' subscription status verification.",
          severity: "Medium",
  ...
  skills: [
    {
      name: "Red Teaming Specialist",
      category: "cybersecurity",
      level: 96,
      details:
        "Penetration testing, Active Directory attacks, threat simulation, security auditing.",
    },
    {
      ...
      level: 94,
      details:
        "Vulnerability assessment, code auditing, secure architecture design.",
    },
    {
      name: "Front End & Backend Developer",
      category: "development",
      level: 92,
      details:
        "Advanced React, Node.js, Next.js, API engineering, custom state engines.",
    },
    {
      name: "AI Developer",
      category: "development",
      level: 89,
      details:
        "Machine learning, conversational NLP agents, prompt engineering, automation.",
    },
    {
      ...
      level: 85,
      details:
        "NAS setup, docker, network storage configuration, secure cloud instances.",
    },
    {
      name: "Digital Marketing & Crypto Mining",
      category: "marketing",
      level: 80,
      details:
        "Crypto mining rig setup, optimization, SEO algorithms, tactical campaigns.",
    },
    {
      name: "Designer Thinker",
      category: "design",
      level: 95,
      details:
        "Human-centric UX engineering, wireframes, high-impact CSS art, branding.",
    },
    {
      ...
      level: 88,
      details:
        "Technical editing, asset optimization, dynamic motion graphics, content composition.",
    },
    {
      name: "SEO & Copywriting / Lead Gen",
      category: "marketing",
      level: 82,
      details:
        "Conversion writing, search authority generation, secure B2B capture forms.",
    },
  ] as Skill[],
  education: [
    {
