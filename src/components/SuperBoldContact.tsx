...
import { Mail, Phone, Copy, Check, Terminal, ExternalLink, Instagram } from "lucide-react";
    ...
    <section id="contact" className="py-24 bg-black relative border-b-8 border-brand-red">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 mt-16">
        ...
        <div className="grid grid-cols-12 gap-8 items-stretch">
          ...
          <div className="col-span-12 lg:col-span-12 xl:col-span-12 space-y-8 flex flex-col justify-between" style={{ perspective: "1500px" }}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <span className="font-mono text-xs text-neutral-500 block font-bold mb-4">SMTP ROUTE:</span>
              ...
              >
                ...
                <span className="font-mono text-xs text-neutral-500 block font-bold mb-4">IPSEC TELEPHONY PORT:</span>
              ...
              >
                ...
                <span className="font-mono text-[10px] text-cyan-500 font-black uppercase block mb-2">[ VISUAL INTELLIGENCE FEED ]</span>
                <span className="font-mono text-xs text-neutral-500 block font-bold mb-4">SOCIAL GRID ID:</span>
                ...
                <div className="flex gap-2 shrink-0 mt-auto">
                  ...
                  >
                    {copiedInsta ? <Check className="w-4.5 h-4.5 text-black" /> : <Copy className="w-4.5 h-4.5" />}
            ...
            <div className="bg-neutral-950/60 p-6 border-2 border-neutral-900 rounded font-mono text-xs text-neutral-500 leading-relaxed uppercase space-y-2 select-none shadow-[4px_4px_0px_#FF0000]">
              <Terminal className="w-4 h-4 inline text-brand-red" /> <span className="text-brand-yellow font-black">AUDITING COMMUNICATION LINK PRE-REQUIREMENTS:</span>
