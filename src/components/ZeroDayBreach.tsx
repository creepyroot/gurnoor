...
export default function ZeroDayBreach() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-20 bg-black font-mono text-white border-y-2 border-brand-red relative overflow-hidden flex flex-col items-center justify-center min-h-[400px]"
    >
      ...
      <div className="z-10 text-center max-w-2xl px-6">
        ...
        <p className="text-neutral-400 text-sm mb-12 uppercase tracking-widest leading-relaxed">
          The mainframe firewall drops for milliseconds. Wait for the exact
          moment to inject the payload. Click too early, you get traced. Click
          too late, the port closes.
        </p>
        ...
        >
          {gameState === "ready" && (
            <Zap className="w-16 h-16 animate-ping mb-4" />
          )}
