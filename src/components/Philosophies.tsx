      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b-2 border-neutral-900 pb-8 mb-12">
          ...
          <p className="mt-4 md:mt-0 font-mono text-[10px] text-neutral-500 uppercase max-w-xs md:text-right leading-relaxed">
            A polymath mindset combining offensive security strategy with
        ...
        <div className="grid grid-cols-12 gap-8 mb-16">
          ...
          <div className="col-span-12 lg:col-span-7 grid grid-cols-3 gap-4 font-mono text-xs text-neutral-500 bg-neutral-950/40 p-4 border border-neutral-900 rounded-sm select-none">
            <div className="p-4 border border-neutral-900 bg-black shadow-[4px_4px_0px_#FF0000]">
              ...
              Every security breach starts by observing target logic. The mind
              must think without limits or guardrails.
            </div>
            <div className="p-4 border border-neutral-900 bg-black shadow-[4px_4px_0px_#FFD700]">
              <span className="text-brand-yellow font-bold block mb-2">
                02 / DESTRUCTION
              </span>
              Deconstructing software systems allows us to rebuild them with
            ...
            <div className="p-4 border border-neutral-900 bg-black shadow-[4px_4px_0px_#FFFFFF]">
              ...
              A coder must be an artist. Writing lines of logic that represent
              beautiful visual frameworks.
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Icon
                      className={`w-8 h-8 ${m.accentText} group-hover:scale-110 transition-transform duration-300`}
                    />
                  </div>
                ...
                <div className="border-t border-neutral-900 pt-4 mt-4 bg-black/40 p-3 rounded">
                  <span className="font-mono text-[9px] text-neutral-500 block mb-2 tracking-widest uppercase">
                    CAPABILITY PARADIGM:
                  </span>
                  <ul className="space-y-1">
                    {m.bulletText.map((bullet, idx) => (
                      ...
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${m.color === "red" ? "bg-brand-red" : m.color === "yellow" ? "bg-brand-yellow" : "bg-brand-yellow"} mr-2`}
                        />
                        {bullet}
                      </li>
                    ))}
